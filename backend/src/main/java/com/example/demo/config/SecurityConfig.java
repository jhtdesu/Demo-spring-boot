...
@Configuration
@EnableWebSecurity
public class SecurityConfig { // Note: Implementing WebMvcConfigurer for CORS here is okay, but defining a CorsConfigurationSource bean is often preferred when using http.cors(Customizer.withDefaults())
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // If using session cookies AND modifying state (POST/PUT/DELETE), CSRF is recommended
                .csrf(csrf -> csrf.disable())
                // Session management: Use sessions if needed (required for standard oauth2Login state)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/*.js", "/*.css", "/*.ico", "/*.png", "/*.svg", // Common static file types
                                "/home",   // Your specific permitted paths
                                "/login",  // Still permit access TO the login page itself
                                "/register",
                                "/error",
                ...
                // Configure form login if you want to support username/password alongside OAuth2
                .formLogin(form -> form
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .defaultSuccessUrl("http://localhost:5173/home", true) // Redirect on successful OAuth2 login
                ...
                // Explicitly configure session repository (though IF_REQUIRED usually handles this)
    ...
    // HttpSessionSecurityContextRepository bean - Needed if explicitly configured above
    // @Bean
    ...
    // AuthenticationManager bean - Often needed for formLogin or manual authentication
    @Bean
    public AuthenticationManager authenticationManager(AuthenticationConfiguration authConfig) throws Exception {
        return authConfig.getAuthenticationManager();
    }

    // Remove the WebMvcConfigurer implementation for CORS if using the CorsConfigurationSource bean
    // @Override
